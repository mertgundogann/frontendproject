...
const Profile = () => {
    ...
    return (
        <div className="flex w-full bg-[#4731d3] pt-15 pb-20 pl-116">
            <div className="w-1/4 bg-[#4731d3] ">
